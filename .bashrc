...
if ${use_color} ; then
	...
	if [[ ${EUID} == 0 ]] ; then
        ...
        PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[01;34m\] $(echo "\w" | sed -E "s/.*(\/.+\/.+)\$/…\\1/") $(b=$(git branch --show-current 2>/dev/null); [ -n "$b" ] && echo -ne "\[\033[01;33m\]⎇ ${b}\[\033[00m\] ")\[\033[01;35m\][\j]\[\033[01;32m\] \$\[\033[00m\] '
	fi
